...
function actualizaTablaTipoValorDeclarado() {
    ...
    var table = $("#tbTipoValorDeclaradoDetalle").DataTable({
        ...
        columns: [
            { "data": "IdTipoValorDeclaradoDetalle" }, { "data": "TipoValorDeclarado" }, { "data": "Moneda" },
            { "data": "ImporteReal" }, { "data": "ImporteAjustado" },
            { "data": "UnidadMedida" }, { "data": "CantidadReal" }, { "data": "CantidadAjustada" }, { "data": "TipoRegistro" },
            { "data": "Estado" }
        ],
        columnDefs: [
            {
            ...
            },
            {
                ...
                targets: 6,
                render: function (data, type, row) {
                    return siniestros.ReplaceNumberWithCommas(row.CantidadReal);
                }
            }, {
                className: "numeric-right2",
                targets: 7,
                render: function (data, type, row) {
                    return siniestros.ReplaceNumberWithCommas(row.CantidadAjustada);
                }
            },
            {
                targets: 0,
